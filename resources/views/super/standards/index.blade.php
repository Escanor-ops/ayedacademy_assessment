                                    ...
                                    @foreach($standards as $standard)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.standards.destroy', $standard->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
...
<script>
    function highlightStandard(button) {
        ...
        document.getElementById('updateStandardForm').action = "{{ url('admin/standards') }}/" + standardId;
