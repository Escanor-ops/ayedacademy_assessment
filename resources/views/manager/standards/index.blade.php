    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('manager.standards.store') }}">
                    @csrf
...
<div class="modal fade" id="editStandardModal" tabindex="-1" aria-labelledby="editStandardModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" >
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="updateStandardForm" action="{{ route('manager.standards.update') }}"> 
                    @csrf
                                    ...
                                    @foreach($standards as $standard)
                                        <tr>
                                            ...
                                            <button class="btn btn-primary btn-sm" onclick="highlightStandard(this)" 
                                                ...
                                                <form action="{{ route('manager.standards.destroy', $standard->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('post')
